      ...
      <div className={Style.container}>
        ...
        >
          <form className={Style.lowcontainer}>
                ...
                <Box sx={{ display: "flex", alignItems: "flex-end" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <MenuItem value="universidade publica">
                        Universidade Pública
                      </MenuItem>
                      <MenuItem value="instituto técnico">
                        Instituto Técnico
                      </MenuItem>
            ...
            <div>
              <a href="/login/escola" className={Style.lowtext}>
                Já tem uma conta da escola? Faça login
              </a>
            </div>
            <div>
              <a href="/login" className={Style.lowtext}>
                Não é um usuário escola? Clique aqui
              </a>
            </div>
            <div className={Style.btndiv}>
              <Button
                ...
                variant="contained"
                type="button"
                onClick={RealizaCadastroEscola}
                style={{ backgroundColor: "#235BD5", fontWeight: "500" }}
              >
                CADASTRAR
              </Button>
            </div>
