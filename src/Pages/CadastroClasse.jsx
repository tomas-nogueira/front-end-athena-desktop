          ...
          if (classId) {
            return fetch(`${apiUrl}/schedule/create`, {
              ...
              .then((scheduleData) => {
                if (scheduleData) {
                  antdMessage.success(
                    "Classe e cronograma cadastrados com sucesso!"
                  );
                  // Limpeza dos campos
                  setName("");
                  setGrade("");
            ...
            throw new Error(
              "Erro ao criar a classe - ID da classe não encontrado."
            );
          }
        })
        .catch((error) => {
          ...
          {scheduleItems.map((item, index) => (
            <Box key={index} display="flex" gap={1} alignItems="center" mt={1}>
              <TextField
                ...
                sx={{ width: "20%" }} // Define a largura do campo
                margin="normal"
              >
              ...
              <Autocomplete
                ...
                sx={{ width: "25%" }} // Define uma largura mais compacta para o Autocomplete
              />
              <IconButton onClick={() => handleRemoveScheduleItem(index)}>
                <Remove />
              </IconButton>
            </Box>
          ))}
